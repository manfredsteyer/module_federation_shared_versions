...
import { ExposedWebComponent } from './exposed-web-component';
import { lookupExposedModule } from './federation-utils';
...
(async function() { 
    ...
    rxjs.fromEvent(flightsLink, 'click').subscribe(async _ => {
        ...
        const module = await lookupExposedModule<ExposedWebComponent>('mfe1', './component');
